...
OptSchedDDGWrapperBasic::OptSchedDDGWrapperBasic(
    ...
    const std::string &RegionID, const int NumSolvers, const bool IsParallel)
    : DataDepGraph(MM, LatencyPrecision, NumSolvers, IsParallel), MM(MM), Contex(Context), DAG(DAG),
      RTFilter(nullptr) {
